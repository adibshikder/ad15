...
<body>
	<div class="wrapper">
		<header>
			<div class="header">
				<div class="headerLogo">
					<img src="img/logo.jpg" alt="Logo_Image" width="100%" height="100%"/>
				</div>
				<div class="title">
					<h2>XYZ Hospital</h2>
				</div>
		...
		<div class="contact">
			<p><strong>Address: </strong><i>ZallarPar Road,Hafiz Complex,Zindhabaz,Sylhet</i></p>
			<hr />
			<p><strong>Phone: </strong><i>01641........</i></p>
			<hr />
			<p><strong>Fax: </strong><i>......</i></p>
			<hr />
			<p><strong>Email: </strong><i>adibshikder@gmail.com</i></p>
			<hr />
			<p><strong>Customer care: </strong><i>01781.......</i></p>
			<hr />
			<p><strong>Web Site: </strong><i>www.adxyzhospitasyl.com</i></p>
			<hr>
